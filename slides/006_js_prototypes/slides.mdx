...
### Can a child object modify its parent's properties, thus affecting the rest of its siblings?
...
Membership system - A user can get a membership, which by default will be the basic membership. The user can upgrade or downgrade the membership. Also, a user can check the benefits of its current membership.

Types of memberships:

- Basic: Gives a 10% discount
- Pro: Gives a 25% discount
- VIP: Gives a 35% discount

---

<Codepen url="https://codepen.io/orverduzco/pen/YJRYGp"/>
