...
# Goal
### To know why Semantic HTML is important for your site
---
<WSlide2
  title="Content"
  title2=""
...
# Semantic HTML
### is HTML code that introduces meaning to the web page rather than just presentation
...
## quick excercise
<Notes>
  Everybody raise your hand, as we go through HTML tags if you don't
  recognize an element you stop raising your hand and keep it that
  way for the rest of the excercise.
</Notes>
---
...
/>
<Notes>
  If someone is raising its hand at the end,
  tell them they lie because one of those is not real.
  Which of those is the fake one?
</Notes>
---
...
<Notes>
  Many of these might not be used that much or are being deprecated,
...
<Notes>
  When other developers see your semantic HTML code they will
  be grateful for that extra context.
  Search engines like google can benefit from extracting the data
  that you want them to see instead of they guessing its context.
  Assistive technology like screen readers will give more information
  to humans with disabilities, we will se an example of that later.
</Notes>
---
<WSlide3
